...
location =  str(input('Do you want to give location or proccede to see all ???' + '\n'))

# performe the test here  
if location == location_field:
    find_jobs_btn = driver.find_element_by_xpath('//*[@id="whatWhere"]/div/div/form/div[3]/button')
    find_jobs_btn.click()
