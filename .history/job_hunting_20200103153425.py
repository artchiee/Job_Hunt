...
def match(string_test, list_):
    import re
    words = re.findall(r'\w', string_test)
    return [word for word in words if word in list_]

list_ = ['Casablanca', 'Rabat', 'Tanger', 'Marrakech', 'Agadir', 'Fs']
match('I love Casablanca and Agadir', list_)
