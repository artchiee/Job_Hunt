...
def select_location():
    ...
    try:
        ...
        if choice != convert_choice:
            ...
            if convert_choice in new_return:
                print('found title match :  ', convert_choice)
                if convert_choice in new_href:
                    print('url match  : ' , convert_choice)
                else:
                    print('unmatch url')
                # Now get the link(href) and click it
            else:
                print('unmatch title')
