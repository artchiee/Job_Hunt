                    ...
                    if top_level_tag:
                        ...
                        try:
                            ...
                            for i in next_ul.find_elements_by_tag_name('li'):
                                ...
                                titles_only = ''.join(
                                    re.findall("[a-zA-Z]+", get_titles))
                                contract_types.append(titles_only)
                            print('Avaialble contract types are : ',
                                  contract_types, '\n')
                            sorting_choice = input(
                                str('Fetch results by Contract : '))
                            # Ignore case Sensetive
                            case_sen = re.compile(
                                sorting_choice, flags=re.IGNORECASE)
                            matchobj =list(filter(case_sen.search, titles_only))
                            if matchobj:
                                print('Found : ', case_sen)
                            else:
                                print('Nothing match')
